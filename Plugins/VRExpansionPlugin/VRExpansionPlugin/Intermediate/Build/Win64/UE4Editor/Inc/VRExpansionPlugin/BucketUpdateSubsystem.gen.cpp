...
static struct FScriptStruct_VRExpansionPlugin_StaticRegisterNativesFUpdateBucketDrop
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UBucketUpdateSubsystem_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UBucketUpdateSubsystem_IsObjectFunctionInBucket, "IsObjectFunctionInBucket" }, // 1556538496
		{ &Z_Construct_UFunction_UBucketUpdateSubsystem_K2_AddObjectEventToBucket, "K2_AddObjectEventToBucket" }, // 3027852134
		{ &Z_Construct_UFunction_UBucketUpdateSubsystem_K2_AddObjectToBucket, "K2_AddObjectToBucket" }, // 3923634393
		{ &Z_Construct_UFunction_UBucketUpdateSubsystem_RemoveObjectFromAllBuckets, "RemoveObjectFromAllBuckets" }, // 746266163
		{ &Z_Construct_UFunction_UBucketUpdateSubsystem_RemoveObjectFromBucketByEvent, "RemoveObjectFromBucketByEvent" }, // 1206819953
		{ &Z_Construct_UFunction_UBucketUpdateSubsystem_RemoveObjectFromBucketByFunctionName, "RemoveObjectFromBucketByFunctionName" }, // 1078807062
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UBucketUpdateSubsystem, 118763731);
