...
// End Cross Module References
	...
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UVREPhysicsConstraintComponent_GetGlobalPose_Statics::NewProp_ConstraintFrame = { "ConstraintFrame", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(VREPhysicsConstraintComponent_eventGetGlobalPose_Parms, ConstraintFrame), Z_Construct_UEnum_Engine_EConstraintFrame, METADATA_PARAMS(nullptr, 0) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UVREPhysicsConstraintComponent_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UVREPhysicsConstraintComponent_GetConstraintReferenceFrame, "GetConstraintReferenceFrame" }, // 492597127
		{ &Z_Construct_UFunction_UVREPhysicsConstraintComponent_GetCurrentLinearDistance, "GetCurrentLinearDistance" }, // 137993554
		{ &Z_Construct_UFunction_UVREPhysicsConstraintComponent_GetGlobalPose, "GetGlobalPose" }, // 2623432502
		{ &Z_Construct_UFunction_UVREPhysicsConstraintComponent_GetLocalPose, "GetLocalPose" }, // 2012954336
	...
	IMPLEMENT_CLASS(UVREPhysicsConstraintComponent, 3303761598);
