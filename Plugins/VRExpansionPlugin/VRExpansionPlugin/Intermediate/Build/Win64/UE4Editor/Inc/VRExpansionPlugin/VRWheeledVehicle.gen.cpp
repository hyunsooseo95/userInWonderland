...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AVRWheeledVehicle_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AVRWheeledVehicle_ForceSecondaryPossession, "ForceSecondaryPossession" }, // 1075029708
		{ &Z_Construct_UFunction_AVRWheeledVehicle_SetBindToInput, "SetBindToInput" }, // 3589466483
		{ &Z_Construct_UFunction_AVRWheeledVehicle_SetOverrideController, "SetOverrideController" }, // 3145418379
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(AVRWheeledVehicle, 2465303350);
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_AVRSimpleWheeledVehicle_Statics::ClassParams = {
		...
		0,
		0x009000A4u,
		METADATA_PARAMS(Z_Construct_UClass_AVRSimpleWheeledVehicle_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_AVRSimpleWheeledVehicle_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(AVRSimpleWheeledVehicle, 650671887);
